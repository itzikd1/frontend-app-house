...
@Component({
  ...
  templateUrl: './pinned-notes-tab.component.html',
  styleUrl: './pinned-notes-tab.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class PinnedNotesTabComponent {
  ...
  public readonly filteredPinnedNotes = this.noteFacade.filteredPinnedNotes;
  ...
  /**
   * Unpin a note (remove from pinned)
   */
  public unpinNote(note: Note): void {
